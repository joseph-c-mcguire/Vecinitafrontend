...
- **[docs/INDEX.md](./docs/INDEX.md)**: Índice completo de documentación y referencia
- **[docs/_legacy/SIMPLIFICATION_SUMMARY.md](./docs/_legacy/SIMPLIFICATION_SUMMARY.md)**: Detalles técnicos de los cambios realizados desde la versión original
